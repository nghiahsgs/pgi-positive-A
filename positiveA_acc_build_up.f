...
c      alpha = 0.03125d0
     ...
     +                                     j-dmp_up_size_y)
                  ...
                  !update element in matrix dmm_up
                  do i=dmm_up_size_x+1,dmm_up_size_x+jvm
                     do j=dmm_up_size_y+1,dmm_up_size_y+jvm
                           dmm_up(i,j)=dmm(i-dmm_up_size_x,
     +                                     j-dmm_up_size_y)
                     end do
                  end do
                  dmm_up_size_x=dmm_up_size_x+jvm
                  dmm_up_size_y=dmm_up_size_y+jvm
                  !update element in matrix vp_up
                  do i=vp_up_size_x+1,vp_up_size_x+ivx
                     do j=vp_up_size_y+1,vp_up_size_y+jvp
                           vp_up(i,j)=vp(i-vp_up_size_x,j-vp_up_size_y)
                     end do
                  end do
                  vp_up_size_x=vp_up_size_x+ivx
                  vp_up_size_y=vp_up_size_y+jvp
                  !update element in matrix vm_up
                  do i=vm_up_size_x+1,vm_up_size_x+ivx
                     do j=vm_up_size_y+1,vm_up_size_y+jvm
                           vm_up(i,j)=vm(i-vm_up_size_x,j-vm_up_size_y)
                     end do
                  end do
                  vm_up_size_x=vm_up_size_x+ivx
                  vm_up_size_y=vm_up_size_y+jvm
                  !update element in matrix gp_up
                  do i=gp_up_size_x+1,gp_up_size_x+jvm
                     do j=gp_up_size_y+1,gp_up_size_y+ivx
                           gp_up(i,j)=gp(i-gp_up_size_x,j-gp_up_size_y)
                     end do
                  end do
                  gp_up_size_x=gp_up_size_x+jvm
                  gp_up_size_y=gp_up_size_y+ivx
                  !update element in matrix gm_up
                  do i=gm_up_size_x+1,gm_up_size_x+jvp
                     do j=gm_up_size_y+1,gm_up_size_y+ivx
                           gm_up(i,j)=gm(i-gm_up_size_x,j-gm_up_size_y)
                     end do
                  end do
                  gm_up_size_x=gm_up_size_x+jvp
                  gm_up_size_y=gm_up_size_y+ivx
                  !update element in matrix eig_up
